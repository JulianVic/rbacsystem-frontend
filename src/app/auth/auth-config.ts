...
export const authConfig: AuthConfig = {
  ...
  scope: 'openid profile email urn:zitadel:iam:org:project:id:zitadel:aud urn:zitadel:iam:org:project:role:view urn:zitadel:iam:user:metadata:read', // Modificamos el scope
